...
if MESSAGE is None:
   MSG = '''
🔥🔥 THE TANDAV X USERBOT IS ONLINE 🔥🔥
...
BOT = str(botnickname) if botnickname else "TANDAV"
NAME = str(ALIVE_NAME) if ALIVE_NAME else "TANDAV USERBOT"
...
ID = ID
id = id
REPO = "[TANDAV](https://github.com/SHIVGULSHAN/TANDAV-X-USERBOT/)"
